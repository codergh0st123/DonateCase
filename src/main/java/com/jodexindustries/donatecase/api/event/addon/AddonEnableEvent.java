...
public class AddonEnableEvent extends DCEvent {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof AddonEnableEvent)) {
         return false;
      } else {
         AddonEnableEvent other = (AddonEnableEvent)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof AddonEnableEvent;
   }
   ...
   public String toString() {
      return "AddonEnableEvent(addon=" + this.addon() + ", reason=" + this.reason() + ")";
   }
}
