...
public class AnimationEndEvent extends DCEvent {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof AnimationEndEvent)) {
         return false;
      } else {
         AnimationEndEvent other = (AnimationEndEvent)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof AnimationEndEvent;
   }
   ...
   @Generated
   public AnimationEndEvent(ActiveCase activeCase) {
   ...
   public String toString() {
      return "AnimationEndEvent(activeCase=" + this.activeCase() + ")";
   }
}
